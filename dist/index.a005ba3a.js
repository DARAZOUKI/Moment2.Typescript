...
})({"a8kFa":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "a53f6025a005ba3a";
"use strict";
...
},{}],"4Zklh":[function(require,module,exports) {
var CustomTodoList = /** @class */ function() {
    ...
    CustomTodoList.prototype.addCustomTodoTask = function(task, priority) {
        if (!task || priority < 1 || priority > 3) return false;
        // Check if the task and priority already exist
        for(var _i = 0, _a = this.todos; _i < _a.length; _i++){
            var todo_1 = _a[_i];
            if (todo_1.task === task && todo_1.priority === priority) return false; // Task already exists, return false
        }
        var todo = {
            task: task,
            completed: false,
    ...
    CustomTodoList.prototype.editCustomTodoTask = function(taskIndex, task, priority) {
        if (taskIndex < 0 || taskIndex >= this.todos.length || !task || priority < 1 || priority > 3) return false;
    ...
    CustomTodoList.prototype.deleteCustomTodoTask = function(taskIndex) {
        if (taskIndex < 0 || taskIndex >= this.todos.length) return false;
...
customTodoForm.addEventListener("submit", function(e) {
    ...
    if (!task) showCustomError("Task cannot be empty.");
    else if (isNaN(priority) || priority < 1 || priority > 3) showCustomError("Priority must be a number between 1 and 3.");
    else {
...
},{}]},["a8kFa","4Zklh"], "4Zklh", "parcelRequire4899")
